...
import { cancelSizeSmall_SawMonitorAtom } from "@/components/4-dialogs/2-dlg-create-login/a-create-dialog-atoms/7-2-do-window-size";
        ...
        switch (data.type) {
            ...
            case 'm2r:loaded-files': {
                ...
                const root = emptyFolder
                    ...
                    : getRootFromFpath({ files: deliveredFileContents, fromMain: true, rootFolder: data.rootFolder });
