export const helpRules: { c1: string; c2: string; }[] = [
    ...
    {
        c1: '( )',
        c2: 'Group rule. Randomize order of generated characters inside group. \
        For example: \
    ...
    {
        c1: '[ ]',
        c2: 'Characters set rule. Define a custom character set i.e. [abcdef] would limit the user to only those letters in the specified position. \
        For example: \
    ...
    {
        c1: '{n,m}',
        c2: 'Range rule. Define a range of acceptable occurrences of the previously indicated character set. \
        For example: \
    ...
    {
        c1: '&',
        c2: 'Prevent a character being in the same position as in the most recent password \
        For example: \
