...
export function DialogOptionsBody({ setIsOpen }: { setIsOpen: (v: boolean) => void; }) {
    const snap = useSnapshot(appSettings).ui.fileListOptions.fileListItems;
    return (
        <div className="min-h-56 text-xs">
            ...
            <div className="mt-2 px-4">
                ...
                <Label className="text-xs font-normal flex place-items-center gap-2">
                    <Checkbox checked={snap.showIndex} onCheckedChange={v => appSettings.ui.fileListOptions.fileListItems.showIndex = !!v} />
                    Show file index
                </Label>
