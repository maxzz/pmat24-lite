...
import { type TestManiEnum, type TestScreenEnum, debugSettings, testMani, testScreen } from "@/store/1-atoms/9-ui-state";
import { doLoadFakeManiAtom } from "@/store/7-napi-atoms/3-create-mani-tests-w-fetch";
