...
namespace page324
{
	...
	class collect2_fields_policy_page_t : public ufoptr_t, public CDialogImpl<collect2_fields_policy_page_t>, public wiz_context::context_callback_t
	{
	...
	public:
		...
		enum { IDD = IDD_WIZARD_COLLECT2_FIELDS_POLICY_EXT };
