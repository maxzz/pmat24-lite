...
const panelsStorage: PanelGroupStorage = {
    getItem(name: string): string {
        return appSettings.appUI.resizablesState.positions[name] || '';
    },
    setItem(name: string, value: string): void {
        appSettings.appUI.resizablesState.positions[name] = value; // {"{\"defaultSize\":25},{\"defaultSize\":50}":{"expandToSizes":{},"layout":[50,50]}}
    }
};
...
export function ResizableABPanels() {
    ...
    return (
        <ResizablePanelGroup direction="horizontal" className="w-full _max-w-md" autoSaveId="main" storage={panelsStorage}>
            ...
            <ResizableHandle className="my-[3px] pb-2 items-end z-50" tabIndex={-1}>
