...
import { doDeleteFileUsAtom, doRevealInExplorerAtom, doGetFileUsPathAtom } from "@/store/0-serve-atoms";
...
export function FilesTreeViewContextMenu({ children }: { children: ReactNode; }) {
    ...
    return (
        <ContextMenu>
            ...
            <ContextMenuContent className="data-[state=closed]:animate-none!"> {/* data-... will fix wrong position of the context menu bug */}
                <ContextItems />
            </ContextMenuContent>
        </ContextMenu>
    );
