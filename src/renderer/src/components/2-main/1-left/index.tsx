...
export function PanelA() {
    return (
        <div className="p-1 pr-0.5 h-full text-xs">
            <div className={`h-full ring-border ring-1 rounded-l overflow-hidden ${inputFocusWithinClasses} focus-within:ring-offset-0`}>
