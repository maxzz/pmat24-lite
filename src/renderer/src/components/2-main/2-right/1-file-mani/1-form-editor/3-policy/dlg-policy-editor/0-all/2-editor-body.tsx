...
export function PolicyEditorBody({ atoms, setOpen }: { atoms: Atomize<PolicyUiForAtoms>; setOpen: (v: boolean) => void; }) {
    ...
    return (<>
        ...
        {/* <Label className="inline-flex items-center gap-x-2 select-none cursor-pointer">
            <Checkbox className="size-4 dark-checkbox" checked={enabled} onCheckedChange={() => setEnabled(v => !v)} />
            Enable password policy
        </Label> */}
