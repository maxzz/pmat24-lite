...
export function Column5_Type({ useItAtom, field, className, ...rest }: Column5_TypeProps) {
    ...
    return (
        <div className={classNames("text-[.6rem] 1text-primary-500 bg-mani-muted-nested-foreground bg-mani-foreground rounded flex flex-col items-center select-none", !useIt && "opacity-30 cursor-pointer", className)} {...rest}>
