...
import { type OFormProps, type FileUsCtx } from "@/store/1-file-mani-atoms";
...
function Input_InTestMode({ fileUsCtx }: { fileUsCtx: FileUsCtx; }) {
    ...
    return (<>
        <ChildrenWithLabel2Cols label={modeTextInTest} titleTooltip={optionsTooltips.testMode} labelClasses="justify-end justify-self-end!">
