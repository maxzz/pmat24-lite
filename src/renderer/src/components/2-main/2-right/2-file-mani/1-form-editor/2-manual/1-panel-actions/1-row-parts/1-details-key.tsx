...
const containerClasses1 = "hidden @[300px]/actions:flex items-center justify-between space-x-1";
...
export function DetailsKbd({ item }: { item: ManualFieldState.KbdForAtoms; }) {
    ...
    return (
        <div className={containerClasses1}>
            <div>
...
//TODO: use sub-grid to align the key name to the left
