...
export function DropdownValue({ useItAtom, items, selectedIndex, onSetIndex }: DropdownValueProps) {
    return (
        <M.Root>
            <M.Trigger asChild>
                <button className="px-1.5 border-mani-border-separator border-l focus:rounded focus:outline-1 focus:-outline-offset-3 focus:outline-dashed outline-muted-foreground"> {/* group/btn */}
