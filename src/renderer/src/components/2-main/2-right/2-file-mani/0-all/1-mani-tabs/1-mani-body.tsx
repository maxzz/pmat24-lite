...
function ManiBodyGuarded({ fileUsAtom }: { fileUsAtom: FileUsAtom; }) {
    ...
    const activeTab = useSnapshot(appSettings).right.mani.tabs.currentTab;
    ...
    return (
        <Tabs className="p-1 h-full flex flex-col" value={activeTab} onValueChange={(value) => appSettings.right.mani.tabs.currentTab = value}>
