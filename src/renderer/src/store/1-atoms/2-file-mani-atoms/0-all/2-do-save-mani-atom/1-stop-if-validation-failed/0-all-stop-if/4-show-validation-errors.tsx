...
export function showValidationErrors({ fromTab, verifyErrors }: { fromTab: string | undefined; verifyErrors: VerifyError[] | undefined; }): boolean | undefined {
    ...
    if (fromTab) {
        ...
        // appSettings.right.mani.activeTab = verifyErrors[0].tab; // or like this
    }
