    ...
    useEffect(
        () => {
            ...
            function onDrop(event: DragEvent) {
                ...
                // Extract files synchronously - dataTransfer.files/items are only available during the event and will be empty if accessed asynchronously (e.g., in async Jotai atom)
